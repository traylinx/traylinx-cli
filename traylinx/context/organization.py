...
class ContextManager:
    ...
    def _transform_settings_to_context(settings: dict[str, Any]) -> dict[str, Any]:
        ...
        for org in orgs:
            org_data = {"id": org.get("id"), "name": org.get("name"), "projects": []}

            # Extract projects
            for project in org.get("projects", []):
                org_data["projects"].append({"id": project.get("id"), "name": project.get("name")})
    ...
    @staticmethod
    def sync_to_api(org_id: str | None = None, project_id: str | None = None) -> bool:
        """
    ...
    @staticmethod
    def get_current_organization() -> dict[str, Any] | None:
    ...
    @staticmethod
    def get_projects(org_id: str | None = None) -> list[dict[str, Any]]:
        """
